...
public class ModbusSlaveException extends ModbusException {
     ...
     * <p>
     *
     * @param TYPE the type to test this <tt>ModbusSlaveException</tt> type            against.
     * @return true if this <tt>ModbusSlaveException</tt> is of the given type,         false otherwise.
     * @see net.wimpi.modbus.Modbus
     */
