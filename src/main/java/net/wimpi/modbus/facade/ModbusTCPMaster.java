...
public class ModbusTCPMaster {
  ...
  private boolean m_Reconnecting = false;
     ...
     *
     * @param b true if a new connection should be established for each          transaction, false otherwise.
     */
     ...
     *
     * @return true if a new connection should be established for each         transaction, false otherwise.
     */
