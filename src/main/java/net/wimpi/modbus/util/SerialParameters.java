...
public class SerialParameters {
  ...
  private int m_ReceiveTimeout;
     ...
     * @see Modbus#SERIAL_ENCODING_ASCII Modbus#SERIAL_ENCODING_ASCII
     * @see Modbus#SERIAL_ENCODING_RTU Modbus#SERIAL_ENCODING_RTU
     * @see Modbus#SERIAL_ENCODING_BIN Modbus#SERIAL_ENCODING_BIN
     */
